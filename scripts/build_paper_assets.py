...
def write_plot3_source_catalog() -> None:
    ...
    plot3 = pd.DataFrame(
        [
            ...
            },
            {
                ...
                "what_it_is_why_possible_candidate": "This corpus looked high-yield because the research pass found preregistered hypotheses, first matched paper results, effective sample size, and Fisher-z/r-like effect fields. That is close to the Plot 3 row definition if the OSF files verify those fields.",
                "confirmed_fields": "Known from the research pass: a 193-study current sample and earlier 459-preregistered-study corpus are described; reported fields include matched hypothesis-result rows, first-result selector, effective N, and Fisher-z/r-like effects. Confirmed locally: no OSF data file has yet been downloaded or parsed.",
                ...
                "why": "not included yet because exact OSF files, variables, row count, and duplicate overlap have not been audited",
                "why_in_out": "Not included yet: potentially large and important, but it needs a local OSF download, field verification, r/Fisher-z-to-D conversion check, and DOI-level deduplication against existing Schäfer/Schwarz, Scheel, SCORE, PSA, and ManyBabies rows.",
            },
            {
                "plot_name": "Plot 3",
                "plot_inclusion_status": "not_included",
    ...
    lines = [
        ...
        "### What Is Still Missing",
        "",
        "- The included core now combines Registered Reports, PSA-CR001 and PSA-CR002 pooled/preregistered hypothesis rows, PSA004 pooled Gettier evidence, ManyBabies 1, the Schäfer/Schwarz preregistered key-effect sample, and SCORE preregistration-indicated paper-level rows.",
        "- The expanded considered-but-not-included list now names the major local preregistered-like sidecars separately: Many Labs, RRR pair rows, PSA replication rows, Transparent Psi, ManyBabies 3, ManyBabies 4, ManyClasses 2, ERN/Pe, self-control fMRI, Twomey, Linden, Protzko, AACT/ClinicalTrials.gov, CliniFact, Brodeur preregistered/PAP economics table tests, Nordic trial reporting, FReD, communication privacy, retrieval-extinction rats, and the van den Akker preregistration-in-practice corpus.",
