...
- Local row universe shown in the subplot buckets: **3,084**.
- Full accounting denominator including parser-repair and duplicate-risk rows: **3,368**.
...
| --- | --- | --- | --- | --- | --- |
| Strict Figure 1A direct D/N rows | 1736 | main Figure 1A | yes | yes | yes |
