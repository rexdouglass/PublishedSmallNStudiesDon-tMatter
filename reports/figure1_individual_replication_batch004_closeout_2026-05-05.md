# Figure 1 Individual Replication batch004 Closeout

batch004 is closed for row-finding. Remaining work is either manual acquisition/source extraction or a future policy/native-route question.

## Outputs

- Manual acquisition tasks: `steps/individual_replication_papers/figure1/individual-paper-manual-acquisition-task-batch004.tsv` (4 rows)
- Dedupe baseline: `steps/individual_replication_papers/figure1/individual-paper-dedupe-baseline-batch004.tsv` (343 rows)
- batch005 dedupe seed: `steps/individual_replication_papers/figure1/individual-paper-batch005-dedupe-seed.tsv` (343 rows)
...
Use `individual-paper-batch005-dedupe-seed.tsv` as an exclusion/manual-acquisition seed before screening new paper-level hits.
